...
SELECT lost_dog_collars.dog_name AS lost_dog_collars_with_owners, dog_owners.name AS known_owners
...
SELECT lost_dog_collars.dog_name AS lost_collars_unknown_owners
FROM lost_dog_collars
...
SELECT dog_owners.name AS owner, lost_dog_collars.dog_name AS lost_collar
FROM lost_dog_collars
RIGHT OUTER JOIN dog_owners
ON lost_dog_collars.dog_name = dog_owners.dog_name;

SELECT dog_owners.name AS dog_owner, lost_dog_collars.dog_name AS lost_dog_collar
FROM dog_owners
